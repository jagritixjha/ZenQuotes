...
/// converting each map in allQuoteData (by iterating using map method) to an object and
/// stores this object into a list allQuotes
/// forming list/array of objects.
List<Quotes> allQuotes =
    allQuoteData.map((e) => Quotes.fromMap(object: e)).toList();

/// takes category from each object in allQuotes list,
